    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(choices=[('Фентези', 'Фентези'), ('Комедия', 'Комедия'), ('Детектив', 'Детектив')], default='Детектив', max_length=100)),
                ('author_gmail', models.EmailField(max_length=254, verbose_name='Укажите эл.почту автора')),
                ('author', models.CharField(default='Азамат Айталиев', max_length=100, verbose_name='Укажите автора')),
